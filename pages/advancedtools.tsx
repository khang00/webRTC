  ...
  render() {
    return (
      <div className="advanced-tools-layout">
        ...
        <AccountInfo
          title="Grafana"
          iconurl="https://i.pinimg.com/originals/ed/52/04/ed52045809ad01c33d1e1859531cb264.jpg"
          username="admin"
          password="admin"
          url="http://rtc-test.fromlabs.com:3000/"
        />
        <AccountInfo
          title="InfluxDB"
          iconurl="https://assets.zabbix.com/img/brands/influxdb.svg"
          username="admin"
          password="12345678"
